...
const REPO_PATH: &str = "./oslogigguide";
const REPO_URL: &str = "https://github.com/Kyrremann/oslogigguide.git";
const GIT_AUTHOR: &str = "OGG Bot";
const GIT_AUTHOR_EMAIL: &str = "ogg-scaleway[bot]@users.noreply.github.com";
...
pub async fn commit_and_push(
    ...
    let author = Signature::now(GIT_AUTHOR, GIT_AUTHOR_EMAIL)
